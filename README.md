...
3. Update frequency: pooling frequency from the website (in seconds). The default is 2 seconds. Note: the data is also received via push on MQTT channel (i.e. immediately) regardless of this setting.
