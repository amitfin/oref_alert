...
***A demo (in Hebrew) of the installation, configuration and usage can be found [here](https://youtu.be/uT77BKvOSyw). A blogpost with Hebrew instructions can be found [here](https://homeusmart.blogspot.com/2023/10/haoref-heb.html).***
